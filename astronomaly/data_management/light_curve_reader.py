...
class LightCurveDataset(Dataset):
    def __init__(self, directory='', list_of_files=[], lower_mag=1, 
                 upper_mag=25, **kwargs):
        """
         Read in a set of images either from a directory or from a list of 
         file paths (absolute)
        ...
        fits_index : integer, optional
            If these are fits files, specifies which HDU object in the list 
            to work with
        ...
        super().__init__(directory=directory, list_of_files=list_of_files, 
                         lower_mag=lower_mag, upper_mag=upper_mag, **kwargs)
