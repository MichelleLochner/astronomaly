...
data_dir = '/home/verlon/Desktop/MSc/Data/Input/Coadd000/0001m002/'
#data_dir = './'
...
if which_data == 'meerkat':
    ...
    window_size = 32
    catalogue = utils.convert_tractor_catalogue(os.path.join(data_dir, 'Catalogue','tractor-0001m002.fits'),
    os.path.join(data_dir, 'Images','g-legacysurvey-0001m002-image.fits'))
#    catalogue = pd.read_csv(
#        os.path.join(
