...
lc_path = os.path.join(data_dir, 'plastic_all_class_20k.csv')

# Where output should be stored
output_dir = os.path.join(
    data_dir, 'astronomaly_output', 'plasticc_all_classes_1000', '')
...
def run_pipeline():
    ...
    anomalies = artificial_human_labelling(
        anomalies=anomalies, metadata=lc_dataset.metadata, N=1000,
        human_labels={90: 0,
                      67: 0,
                      52: 0,
                      42: 0,
